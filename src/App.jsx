  ...
  const renderContent = () => {
    ...
    if (active === 'chat') return (
      <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
        ...
        <SageChat provider={provider} model={model} apiKeys={apiKeys} context="Full SAP Domain" sectionId="default" sessionId={activeSessionId} />
      </div>
    );
    ...
    if (meta) {
      ...
      return (
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
          ...
          <SageChat provider={provider} model={model} apiKeys={apiKeys} context={meta.title} sectionId={active} sessionId={activeSessionId} />
        </div>
      );
    }
